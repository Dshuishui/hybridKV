...
usage() {
    ...
    echo ""
    echo "Parameters:"
    echo "  -a, --address          Client address (e.g., 192.168.1.10:8888)"
    echo "  -i, --internal         Internal address (e.g., 192.168.1.10:88881)"
    echo "  -p, --peers           Peers list (e.g., 192.168.1.10:88881,192.168.1.11:88881,192.168.1.12:88881)"
    echo ""
    echo "Example:"
    echo "  $0 -a 192.168.1.10:8888 -i 192.168.1.10:88881 -p 192.168.1.10:88881,192.168.1.11:88881,192.168.1.12:88881"
    echo ""
